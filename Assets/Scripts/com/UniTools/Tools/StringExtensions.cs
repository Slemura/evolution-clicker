...
namespace UniTools {
	public static class StringExtensions {
	    ...
	    public static string AllToLowerFirstCharToUpper(this string input) {
		    
	        switch (input) {
	            case null:
		            return "";//throw new ArgumentNullException(input);
	            case "": return "";//throw new ArgumentException("string cannot be empty");
