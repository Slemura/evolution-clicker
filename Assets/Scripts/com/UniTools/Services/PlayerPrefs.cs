...
namespace PreviewLabs
{
	public static class PlayerPrefs
	{
		...
		private static readonly string fileName = Application.persistentDataPath + "/data.txt";
		private static readonly string secureFileName = Application.persistentDataPath + "/sec_data.txt";
		//NOTE modify the iw3q part to an arbitrary string of length 4 for your project, as this is the encryption key
		private static byte[] bytes = ASCIIEncoding.ASCII.GetBytes("1234" + SystemInfo.deviceUniqueIdentifier.Substring(0, 4));
