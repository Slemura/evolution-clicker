...
/// <summary>
/// Putting these in the global namespace com.mikecann.scripts {
namespace com.mikecann.scripts {
    ...
    public static Vector3 VectorBoundInBound(this Vector3 v, Bounds inner_bounds, Bounds external_bounds) {
        if (v.x + inner_bounds.extents.x > external_bounds.max.x) {
            v.x = external_bounds.max.x - inner_bounds.extents.x;
        } else if (v.x - inner_bounds.extents.x < external_bounds.min.x) {
            v.x = external_bounds.min.x + inner_bounds.extents.x;
        }
				                 
        if (v.y + inner_bounds.extents.y > external_bounds.max.y) {
            v.y = external_bounds.max.y - inner_bounds.extents.y;
        } else if (v.y - inner_bounds.extents.y < external_bounds.min.y) {
            v.y = external_bounds.min.y + inner_bounds.extents.y;
        }
